    ...
    \begin{center}
        ...
        \begin{minipage}{\textwidth}
            \begin{flushright}
                \performancepiece
                {Blue Skies}
                {from \emph{Betsy}. Arranged by Steve Zegree}
                ...
                \performancepiece
                {Let the River Run}
                {from \emph{Working Girl.} Arranged by Craig Hella Johnson}

                \fleurons

                \showcase
                {Can You Feel the Love Tonight}
                {from \emph{The Lion King}}
                {Barbara Gao Shapiro}
                ...
                {June Hymn}
                {by The Decemberists}
                {\\ Bekah Barnett, Matt Gershowitz, and Melissa June Kosovych}
                ...
                \performancepiece
                {Wanting Memories}
                {from \emph{Crossings}. By Ysaye M. Barnwell}
